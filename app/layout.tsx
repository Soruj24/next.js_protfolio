...
export const metadata: Metadata = {
  ...
  description: "AI Software Architect specializing in LangChain, MCP Servers, and Autonomous Agentic Workflows. Building the future of intelligent systems.",
  keywords: ["AI", "LangChain", "MCP Server", "Autonomous Agents", "Software Architect", "Soruj Mahmud", "Portfolio", "Next.js", "React"],
  ...
  openGraph: {
    ...
    title: "Soruj Mahmud | AI Software Architect & LangChain Specialist",
    description: "AI Software Architect specializing in LangChain, MCP Servers, and Autonomous Agentic Workflows.",
