  ...
  return (
    <div className="flex items-center gap-6 px-8 py-3 bg-white/[0.03] border border-white/5 rounded-full backdrop-blur-xl">
      <div className="flex items-center gap-2">
        ...
        <span className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400">of</span>
      ...
      <div className="flex items-center gap-2">
        <span className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400">Results</span>
        <span className="text-sm font-black text-white">
