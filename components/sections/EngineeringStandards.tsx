...
const defaultStandards = [
  {
    ...
    description:
      "Building highly reusable, atomic components following the Compound Component and Render Props patterns for maximum flexibility.",
    icon: "💎",
  ...
  },
  {
    ...
    description:
      "Optimizing for Core Web Vitals, implementing advanced code splitting, and ensuring 95+ Lighthouse scores for all production frontends.",
    icon: "🌿",
    metrics: "95+ Score",
  ...
  },
  {
    ...
    description:
      "Adopting TDD with Vitest, React Testing Library, and Playwright to ensure robust components and zero-regression deployments.",
    icon: "🧪",
    metrics: "90% Coverage",
  ...
  },
  {
    ...
    description:
      "Scaling UI development through robust design systems, Storybook documentation, and maintaining consistent design tokens.",
    icon: "📄",
    metrics: "Documented",
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        <SectionTitle
          ...
          subtitle="How I ensure production-grade reliability and maintainability"
        />
        ...
        <div className="mt-16 p-8 rounded-3xl bg-gradient-to-r from-cyan-900/20 via-blue-900/20 to-purple-900/20 border border-white/10 flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            <h4 className="text-xl font-bold text-white mb-2">
              Ready for Enterprise Challenges
            </h4>
            <p className="text-zinc-400">
              I build applications that are not just functional, but reliable,
