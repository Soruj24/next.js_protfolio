...
const SkillCategoryCard = forwardRef<HTMLDivElement, SkillCategoryCardProps>(
  ({ category, categoryIndex, addToRefs }, ref) => {
    ...
    return (
      ...
      >
        <div className="bg-white/5 backdrop-blur-2xl rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-8 border border-white/10 hover:border-cyan-500/50 transition-all duration-700 h-full relative overflow-hidden group-hover:shadow-[0_0_50px_rgba(6,182,212,0.15)]">
          {/* Background Accent */}
          ...
          <div className="flex items-center mb-6 sm:mb-10 relative z-10">
            <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500/20 to-blue-500/20 rounded-2xl flex items-center justify-center text-xl sm:text-2xl mr-4 sm:mr-5 border border-white/10 group-hover:scale-110 group-hover:border-cyan-500/50 transition-all duration-500 shadow-inner">
              ...
              <div key={`${skill.name}-${skillIndex}`} className="group/skill">
                <div className="flex justify-between items-center mb-2 sm:mb-3">
                  <div className="flex items-center space-x-2 sm:space-x-3">
                    <span className="text-lg sm:text-xl group-hover/skill:scale-125 transition-transform duration-300">
                      {skill.icon}
                    </span>
