...
export default function ProjectTable({
  ...
  const allSelected =
    projects.length > 0 &&
    projects.every((p) => selectedIds.has((p._id || p.id) as string));
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-white/[0.06]">
              ...
              <th className="px-4 py-3 text-right text-[10px] font-bold text-gray-500 uppercase tracking-wider w-20">
                Actions
              </th>
            </tr>
          </thead>
